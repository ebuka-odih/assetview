            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="block block-rounded">
                        <ul class="nav nav-tabs nav-tabs-block" role="tablist">
                            <li class="nav-item">
                                <a href="{{ route('admin.fund') }}" class="nav-link active" id="btabs-animated-fade-home-tab" >Add Fund</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="block block-rounded">
                        <ul class="nav nav-tabs nav-tabs-block" role="tablist">
                            <li class="nav-item">
                                <a href="{{ route('admin.defund') }}" class="nav-link" id="btabs-animated-fade-profile-tab" >Defund Account</a>
                            </li>
                        </ul>
                    </div>
                    <!-- END Block Tabs Animated Fade -->
